...
COPY --from=frontend-build /app/src/opentaak/static /app/src/opentaak/static
...
ENV RELEASE=${RELEASE} \
    GIT_SHA=${COMMIT_HASH} \
    PYTHONUNBUFFERED=1 \
    DJANGO_SETTINGS_MODULE=opentaak.conf.docker

ARG SECRET_KEY=dummy

LABEL org.label-schema.vcs-ref=$COMMIT_HASH \
      org.label-schema.vcs-url="https://github.com/maykinmedia/opentaak" \
      org.label-schema.version=$RELEASE \
      org.label-schema.name="opentaak"
