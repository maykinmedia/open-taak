...
from opentaak.accounts.views.password_reset import PasswordResetView
...
admin.site.site_header = "opentaak admin"
admin.site.site_title = "opentaak admin"
admin.site.index_title = "opentaak dashboard"
