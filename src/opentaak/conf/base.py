...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "opentaak"),
        "USER": config("DB_USER", "opentaak"),
        "PASSWORD": config("DB_PASSWORD", "opentaak"),
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "opentaak.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "opentaak.wsgi.application"
...
DEFAULT_FROM_EMAIL = "opentaak@example.com"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOGGING_DIR / "opentaak.log",
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "opentaak.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "opentaak_sessionid"
...
CSRF_FAILURE_VIEW = "opentaak.accounts.views.csrf_failure"
...
TWO_FACTOR_WEBAUTHN_RP_NAME = "opentaak"
...
ELASTIC_APM = {
    "SERVICE_NAME": f"opentaak {ENVIRONMENT}",
