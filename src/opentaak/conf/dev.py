...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-9@%l%3j^zy4+&r2wgv$_higef)u^roxxm214k7&0=l*9=q@q68",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "opentaak")
os.environ.setdefault("DB_USER", "opentaak")
os.environ.setdefault("DB_PASSWORD", "opentaak")
